package com.minlia.cloud.i18n.code;


import com.minlia.cloud.i18n.annotation.Localize;
import com.minlia.cloud.i18n.annotation.Localized;
...
public abstract class ApiCode {
   ...
   * 基数
   */
  public static final int BASED_ON = 1000;
  ...
  public static final int NOT_NULL = BASED_ON + 1;
  ...
  public static final int UNKNOWN_EXCEPTION = BASED_ON + 2;
  ...
  public static final int NULL_POINTER_EXCEPTION = BASED_ON + 3;
  ...
  public static final int NOT_FOUND = BASED_ON + 4;
